...
public class SubsController {
    ...
    @Autowired
    public SubsController(CreatorService service, CreatorPostService creatorPostService, MemberService memberService, SubscrService subscrService, SubListService subListService) {
    ...
    public String main(HttpSession session, Model model) {
        ...
        System.out.println("postListpostListpostListpostList  "+ postList);
